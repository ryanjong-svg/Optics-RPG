...
import { openWhatsNew, closeWhatsNew, hasUnseenChangelog } from './engine/panels/whatsNewUI.js';
import { openChronicle, closeChronicle, chronicleUnlockedCount } from './engine/panels/chronicleUI.js';
import { openCompletion, closeCompletion } from './engine/panels/completionUI.js';
import { openMap, closeMap } from './engine/panels/mapUI.js';
import { openQuestLog, closeQuestLog, hasReadyQuest } from './engine/panels/questLogUI.js';
import { showMessages, advanceDialogue } from './engine/panels/dialogueUI.js';
import { renderSnellPuzzle, fireSnellPuzzle, closeSnellPuzzle } from './engine/puzzles/snellPuzzleUI.js';
